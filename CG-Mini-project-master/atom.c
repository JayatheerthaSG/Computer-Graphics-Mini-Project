...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "AMRUTA INSTITUTE OF ENGINEERING AND MANAGEMENT SCIENCES";
        drawhead(-630, 900, 0, cn);
        char pn[] = "Bidadi, Bangalore- 562109";
        drawsubhead(-200, 850, 0, pn);
        ...
        drawhead(-220, 350, 0, pro);

        char pb[] = "PROJECT BY: ";
        drawhead(-690, -150, 0, pb);

        char p1[] = "Jayatheertha S G";
        drawhead(-690, -250, 0, p1);
        char p1u[] = "1AR19CS018";
        drawsubhead(-690, -300, 0, p1u);

        char p2[] = "Vishwas Gowda H V";
        ...
        char g1[] = "DR, Rajshekar Patil";
        drawhead(290, -250, 0, g1);
        char d1[] = "Associate Professor, Dept. Of CSE, AIEMS";
